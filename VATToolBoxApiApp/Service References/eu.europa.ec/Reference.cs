...
namespace VATToolBoxApiApp.eu.europa.ec {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="eu.europa.ec.checkVatPortType")]
    public interface checkVatPortType {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        VATToolBoxApiApp.eu.europa.ec.checkVatResponse checkVat(VATToolBoxApiApp.eu.europa.ec.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatResponse> checkVatAsync(VATToolBoxApiApp.eu.europa.ec.checkVatRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse checkVatApprox(VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse> checkVatApproxAsync(VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatRequest {
        ...
        public VATToolBoxApiApp.eu.europa.ec.checkVatRequestBody Body;
        
        public checkVatRequest() {
        }
        
        public checkVatRequest(VATToolBoxApiApp.eu.europa.ec.checkVatRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatResponse {
        ...
        public VATToolBoxApiApp.eu.europa.ec.checkVatResponseBody Body;
        
        public checkVatResponse() {
        }
        
        public checkVatResponse(VATToolBoxApiApp.eu.europa.ec.checkVatResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxRequest {
        ...
        public VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequestBody Body;
        
        public checkVatApproxRequest() {
        }
        
        public checkVatApproxRequest(VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxResponse {
        ...
        public VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponseBody Body;
        
        public checkVatApproxResponse() {
        }
        
        public checkVatApproxResponse(VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class checkVatApproxResponseBody {
        ...
        public VATToolBoxApiApp.eu.europa.ec.matchCode traderNameMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=11)]
        public VATToolBoxApiApp.eu.europa.ec.matchCode traderCompanyTypeMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=12)]
        public VATToolBoxApiApp.eu.europa.ec.matchCode traderStreetMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=13)]
        public VATToolBoxApiApp.eu.europa.ec.matchCode traderPostcodeMatch;
        
        [System.Runtime.Serialization.DataMemberAttribute(Order=14)]
        public VATToolBoxApiApp.eu.europa.ec.matchCode traderCityMatch;
        ...
        public checkVatApproxResponseBody(
                    ...
                    string traderCity, 
                    VATToolBoxApiApp.eu.europa.ec.matchCode traderNameMatch, 
                    VATToolBoxApiApp.eu.europa.ec.matchCode traderCompanyTypeMatch, 
                    VATToolBoxApiApp.eu.europa.ec.matchCode traderStreetMatch, 
                    VATToolBoxApiApp.eu.europa.ec.matchCode traderPostcodeMatch, 
                    VATToolBoxApiApp.eu.europa.ec.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface checkVatPortTypeChannel : VATToolBoxApiApp.eu.europa.ec.checkVatPortType, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<VATToolBoxApiApp.eu.europa.ec.checkVatPortType>, VATToolBoxApiApp.eu.europa.ec.checkVatPortType {
        ...
        VATToolBoxApiApp.eu.europa.ec.checkVatResponse VATToolBoxApiApp.eu.europa.ec.checkVatPortType.checkVat(VATToolBoxApiApp.eu.europa.ec.checkVatRequest request) {
        ...
        public string checkVat(ref string countryCode, ref string vatNumber, out bool valid, out string name, out string address) {
            VATToolBoxApiApp.eu.europa.ec.checkVatRequest inValue = new VATToolBoxApiApp.eu.europa.ec.checkVatRequest();
            inValue.Body = new VATToolBoxApiApp.eu.europa.ec.checkVatRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            VATToolBoxApiApp.eu.europa.ec.checkVatResponse retVal = ((VATToolBoxApiApp.eu.europa.ec.checkVatPortType)(this)).checkVat(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatResponse> VATToolBoxApiApp.eu.europa.ec.checkVatPortType.checkVatAsync(VATToolBoxApiApp.eu.europa.ec.checkVatRequest request) {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatResponse> checkVatAsync(string countryCode, string vatNumber) {
            VATToolBoxApiApp.eu.europa.ec.checkVatRequest inValue = new VATToolBoxApiApp.eu.europa.ec.checkVatRequest();
            inValue.Body = new VATToolBoxApiApp.eu.europa.ec.checkVatRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            return ((VATToolBoxApiApp.eu.europa.ec.checkVatPortType)(this)).checkVatAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse VATToolBoxApiApp.eu.europa.ec.checkVatPortType.checkVatApprox(VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest request) {
        ...
        public string checkVatApprox(
                    ...
                    out VATToolBoxApiApp.eu.europa.ec.matchCode traderNameMatch, 
                    out VATToolBoxApiApp.eu.europa.ec.matchCode traderCompanyTypeMatch, 
                    out VATToolBoxApiApp.eu.europa.ec.matchCode traderStreetMatch, 
                    out VATToolBoxApiApp.eu.europa.ec.matchCode traderPostcodeMatch, 
                    out VATToolBoxApiApp.eu.europa.ec.matchCode traderCityMatch, 
                    out string requestIdentifier) {
            VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest inValue = new VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest();
            inValue.Body = new VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            ...
            VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse retVal = ((VATToolBoxApiApp.eu.europa.ec.checkVatPortType)(this)).checkVatApprox(inValue);
            countryCode = retVal.Body.countryCode;
            vatNumber = retVal.Body.vatNumber;
            valid = retVal.Body.valid;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse> VATToolBoxApiApp.eu.europa.ec.checkVatPortType.checkVatApproxAsync(VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest request) {
            return base.Channel.checkVatApproxAsync(request);
        }
        
        public System.Threading.Tasks.Task<VATToolBoxApiApp.eu.europa.ec.checkVatApproxResponse> checkVatApproxAsync(string countryCode, string vatNumber, string traderName, string traderCompanyType, string traderStreet, string traderPostcode, string traderCity, string requesterCountryCode, string requesterVatNumber) {
            VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest inValue = new VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequest();
            inValue.Body = new VATToolBoxApiApp.eu.europa.ec.checkVatApproxRequestBody();
            inValue.Body.countryCode = countryCode;
            inValue.Body.vatNumber = vatNumber;
            ...
            inValue.Body.requesterCountryCode = requesterCountryCode;
            inValue.Body.requesterVatNumber = requesterVatNumber;
            return ((VATToolBoxApiApp.eu.europa.ec.checkVatPortType)(this)).checkVatApproxAsync(inValue);
        }
    }
}
